...
with tab3:
  ...
  with explainer1:
    ...
    st.write("Which we then display flatten onto a grid with a depth of one particle.")
    ...
    st.image("explainre1.5.png", caption = "Equations for flattening blender contents from 3D to 2D")
